...
use tauri::{webview_version, AppHandle, Manager, WebviewWindow};
...
pub fn run() {
  tauri::Builder::default()
    ...
    .setup(|app| {
      ...
      let mindbar_window = app.handle()
        .get_webview_window("mindbar")
        .unwrap();
      mindbar_window.hide().unwrap();
      mindbar_window.set_visible_on_all_workspaces(true).unwrap();
      mindbar_window.hide_menu().unwrap();
      ...
      mindbar_window.on_window_event(move |event| {
        ...
        if let tauri::WindowEvent::Focused(focused) = event {
          ...
          mindbar_window_clone.hide().unwrap();
          mindbar_window_clone.minimize().unwrap();
          app_handle
      ...
      app.global_shortcut().register(ctrl_space_shortcut)?;
